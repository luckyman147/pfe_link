  ...
  return (
    <form className="flex flex-col gap-6" onSubmit={(e) => { e.preventDefault(); handleSubmit(onSubmit)(); }}>
      ...
      <p className="text-[10px] text-center text-stitch-on-surface-variant/40 leading-relaxed">
        This portal is protected by reCAPTCHA and the Google <br />
        <a href="https://policies.google.com/privacy" className="underline hover:text-stitch-primary">Privacy Policy</a> and
        <a href="https://policies.google.com/terms" className="underline hover:text-stitch-primary ml-1">Terms of Service</a> apply.
      </p>
    </form>
  );
};
